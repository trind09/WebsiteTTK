<%@ Page Title="Customer" Language="C#" MasterPageFile="~/admin/admin.master" AutoEventWireup="true" CodeFile="Customer.aspx.cs" Inherits="admin_Customer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server">
        ...
        <div>
            <div class="container" ng-app="app" ng-controller="TodoController">
                ...
                <div class="row">
                    ...
                    <table id="lista-compras" class="table table-striped">
                        ...
                        <tbody>
                            <tr ng-repeat="item in filteredItems | orderBy:sortField:reverseOrder | filter:searchValue | startFrom:(currentPage - 1) * numPerPage | limitTo:numPerPage" class="comprado-{{ item.customer_id }}">
                                <td><input type='checkbox' ng-checked="checkall" id="item-{{ item.customer_id }}" value="{{ item.customer_id }}"></td>
                                ...
                                <td>{{ item.address }}</td>
                                <td>
                                    <a class="btn btn-warning btn-small" ng-click="editarItem(item.customer_id)">
                                        <i class="icon-pencil icon-white"></i>Edit
                                    </a>
                                    <a class="btn btn-danger btn-small" ng-click="deleteItem(item.customer_id)">
                ...
                <table style="width: 100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="number" ng-model="item.customer_id" placeholder="Customer ID" style="width: 500px;" required></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Last Name: </td>
                            <td><input type="text" ng-model="item.images" placeholder="Last Name" style="width: 500px;"></td>
                        </tr>
                        <tr>
                            <td>Phone: </td>
                        ...
                        <tr>
                            <td>City: </td>
                            <td><input type="text" ng-model="item.city" placeholder="City" class="input-small" style="width: 500px;"></td>
                        </tr>
                         <tr>
                            <td>Zip Code: </td>
                            <td><input type="text" ng-model="item.zip_code" placeholder="Zip Code" style="width: 500px;"></td>
                        </tr>
                         <tr>
                            <td>Address: </td>
            ...
            <script src="AngularJS/app/customer.js"></script>
