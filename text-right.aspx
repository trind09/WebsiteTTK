<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="text-right.aspx.cs" Inherits="text_right" %>
                    ...
                    <div class="col-lg-9">
                        <div id="text-page" class="box">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p class="text-center">
                                        <img src="img/detailsquare.jpg" alt="" class="img-circle img-fluid"></p>
                                    <p class="text-center">circle</p>
                                </div>
                                <div class="col-md-4">
                                    <p class="text-center">
                                        <img src="img/detailsquare.jpg" alt="" class="img-thumbnail img-fluid"></p>
                                    <p class="text-center">thumbnail</p>
                                </div>
                                <div class="col-md-4">
                                    <p class="text-center">
                                        <img src="img/detailsquare.jpg" alt="" class="rounded-circle img-fluid"></p>
                        ...
                        <div class="card sidebar-menu mb-4">
                            ...
                            <div class="card-body">
                                <ul class="nav nav-pills flex-column">
                                    <li><a href="text.aspx" class="nav-link">Text page</a></li>
                                    <li><a href="contact.aspx" class="nav-link">Contact page</a></li>
